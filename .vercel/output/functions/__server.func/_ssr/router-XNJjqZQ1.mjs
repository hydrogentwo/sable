...
//#region node_modules/.nitro/vite/services/ssr/assets/router-XNJjqZQ1.js
var router_XNJjqZQ1_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-DDFcByet.css";
var APP_NAME = "Sable";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Self-hosted MiniCPM5-2B assistant. TPU first. Jcode harness."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-DQdeMjuV.mjs");
...
//#endregion
export { getRouter, router_XNJjqZQ1_exports as t };
