...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BsfA56pb.mjs");
...
var manifest = {
	"1cf051f321140ac2a6c447bb8af8f9b1468b7b1760118abd0e81b198d8ede8a2": {
		functionName: "grabSkillFromGithub_createServerFn_handler",
		importer: () => import("./grab-nBy8iGwC.mjs")
	},
	"87a9557e2f50c40b37faac98b149539793fff8e2adc5a252efe4204a1ad3611c": {
		functionName: "runSableTurn_createServerFn_handler",
		importer: () => import("./chat-aWksJ3nR.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-XNJjqZQ1.mjs").then((n) => n.t),
